...
class SimpleTestStatistics(BaseTestStatistics):
    ...
    :type  ci: dict
    """
    def __init__(self, control_statistics, treatment_statistics, delta, ci, p, alpha, test_statistic, statistical_power):
...
class EarlyStoppingTestStatistics(SimpleTestStatistics):
    ...
    :type  stop: bool
    """
    def __init__(self, control_statistics, treatment_statistics, delta, ci, p, alpha, test_statistic, statistical_power, stop):
        super(EarlyStoppingTestStatistics, self).__init__(control_statistics, treatment_statistics, delta, ci, p , alpha, test_statistic, statistical_power)
        self.stop = stop
